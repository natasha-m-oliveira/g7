...
<body>
    <div class="content">
        <main>
            <div class="container">
                <div class="form">
                    <form name="update-enrollment" action="" method="post" onsubmit="return updateEnrollment()">
                        ...
                        <?php array_filter($registrations, function ($registration) { ?>
                            ...
                            <input type="text" name="first_name" id="first_name" inputmode="verbatim" value="<?=$registration['first_name']?>" required>
                            <label for="last_name">Sobrenome:</label>
                            <input type="text" name="last_name" id="last_name" inputmode="verbatim" value="<?=$registration['last_name']?>" required>
